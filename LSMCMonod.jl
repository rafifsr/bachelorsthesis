...
# Parameters
p = (0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.015, 0.5, 0.5, 0.5)  # parameters for the kinetics
u0 = [2.0, 0.0, 0.0, 10.0]  # Initial concentrations of X, Y, Z, S
T = 60.0
dt = 0.01
N = Int(T/dt)
...
function f!(du, u, p, t)
    ...
    µmax, qymax, qzmax, Kx, Ky, Kz, ms, Yxs, Yys, Yzs = p
    ...
    du[2] = qy * X - qz * Y
    du[3] = qz * Y
    du[4] = - (1 / Yxs) * μx * X - (1 / Yys) * qy * X - (1 / Yzs) * qz * X - ms * X
end
